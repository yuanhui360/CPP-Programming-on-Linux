 #include <iostream>
  ...
  int main(int argc, char* argv[]) {
      ...
      if ( argc != 5 ) {
          printf("Usgae : %s <uri> <database> <collection> <gender: Male|Female>\n", argv[0]);
          printf("uri pattern:\n");
          printf("  mongodb://localhost:27017\n");
          printf("Example:\n");
          printf("  %s mongodb://10.0.0.124:27017 test player Male\n", argv[0]);
          printf("  %s mongodb://10.0.0.124:27017 test player Female\n", argv[0]);
          return -1;
      }
